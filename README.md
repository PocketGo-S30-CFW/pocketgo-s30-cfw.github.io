...
28644 bytes read in 5 ms (5.5 MiB/s)
2317616 bytes read in 100 ms (22.1 MiB/s)
## Booting kernel from Legacy Image at 42000000 ...
   Image Name:   Linux-3.4.113.27-madmonkey
   Image Type:   ARM Linux Kernel Image (uncompressed)
   Data Size:    2317552 Bytes = 2.2 MiB
...
Note: the kernel is not booting up yet, or it's not displaying any output via UART1. Also, if you notice I've just used the madmonkey kernel from [hakchi](https://github.com/madmonkey1907/hakchi) as an example.
